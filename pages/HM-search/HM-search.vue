<template>
	<view class="content">
		...
		<!-- 漂浮头部 -->
		<view class="search-box header" :style="{position:headerPosition}">
			<!-- mSearch组件 如果使用原样式，删除组件元素-->
			<mSearch :mode="1" button="inside" :placeholder="defaultKeyword" @back="back(true)" @search="doSearch(false)" @input="inputChange"
		...
		<view class="search-keyword" @touchstart="blur" style="height:678x">
