<template>
	<view class="serach">
		<view class="content" :style="{'border-radius':radius+'px'}">
			...
			<view v-show="(active&&show&&button === 'inside')" class="serachBtn" @click="search">
				搜索
			</view>
			<view v-show="(!active&&show&&button === 'inside')||(!isDelShow && button === 'inside')" class="serachBtn" @click="back">
				取消
			</view>
		</view>
